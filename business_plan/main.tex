...
%%%%%%%%%%%%%%%%%%%%%%%Start Customisation%%%%%%%%%%%%%%%%%%%%%%%%%
% Specify which document style/target is compiled.
\usepackage{ifthen}
...
\ifx\homepath\overleafhome
  ...
  \def\pathprepend{}% Overleaf automatically looks into /latex.
\else
  % Local compilation
  \def\pathprepend{business_plan/}% Local compilation looks from root dir.
\fi
%%%%%%%%%%%%%%%%%%%%%%%End Customisation%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{\pathprepend /packages/fancyhdr}
...
\rhead{\includegraphics{\pathprepend images/letterhead_right_en.eps}}
\lhead{\includegraphics{\pathprepend images/letterhead_left.eps}}
\rfoot{Draft}
\cfoot{\thepage}
...
\begin{tabular}{| m{92 pt} | m{92 pt} | m{92 pt} | m{92 pt} |}\hline
	\includegraphics[scale=0.40]{\pathprepend images/prod_bpm1.jpg} &
		\includegraphics[scale=0.40]{\pathprepend images/prod_bpm2.jpg} &
		\includegraphics[scale=0.40]{\pathprepend images/prod_bpm3.jpg} &
		\includegraphics[scale=0.40]{\pathprepend images/prod_bpm4.jpg} \\ \hline
...
\begin{tabular}{ | l | l | l | }\hline
  & ODM A & ODM B \\ \hline
  & \includegraphics[scale=0.40]{\pathprepend images/prod_bpm4.jpg}
	&  \\ \hline
...
\begin{tabular}{| m{80 pt} | m{80 pt} | m{80 pt} | m{80 pt} | m{80 pt} |}\hline
	\includegraphics[scale=0.40]{\pathprepend images/prod_bs1.jpg} &
		\includegraphics[scale=0.40]{\pathprepend images/prod_bs2.jpg} &
		\includegraphics[scale=0.40]{\pathprepend images/prod_bs3.jpg} &
		\includegraphics[scale=0.40]{\pathprepend images/prod_bs4.jpg} &
		\includegraphics[scale=0.40]{\pathprepend images/prod_bs5.jpg} \\ \hline
...
tristique senectus et netus et malesuada fames ac turpis egestas.\newline
\begin{tabular}{| m{92 pt} | m{92 pt} | m{92 pt} | m{92 pt} |}\hline
	\includegraphics[scale=0.30]{\pathprepend images/prod_bpm1.jpg} &
		\includegraphics[scale=0.30]{\pathprepend images/prod_bpm2.jpg} &
		\includegraphics[scale=0.25]{\pathprepend images/prod_bpm3.jpg} &
		\includegraphics[scale=0.20]{\pathprepend images/prod_bpm4.jpg} \\ \hline
...
\begin{tabular}{ | l | l | l | }\hline
  & ODM A & ODM B \\ \hline
  & \includegraphics[scale=0.40]{\pathprepend images/prod_bpm4.jpg} & \includegraphics[scale=0.40]{\pathprepend images/prod_bpm4.jpg} \\ \hline
...
\begin{center}
\includegraphics[scale=0.5]{\pathprepend diagrams/org_chart.eps}
\end{center}
\subsection{Graph 1}
lorem ipsum dolor
\includegraphics{\pathprepend graphs/immigration.eps}
\newpage
\thispagestyle{empty}
\begin{landscape}
